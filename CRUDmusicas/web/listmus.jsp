    ...
    <body class="bg-dark">
        <%
            try {
                ...
                st = conecta.prepareStatement("SELECT * FROM musica");
                ResultSet rs = st.executeQuery();
                %>
                <table border="1" class="table table-striped table-dark table-hover" style="table-layout: fixed;">
                    <tr class="align-middle text-center">
                        <th>Número da Faixa </th><th>Capa</th><th>Nome</th><th>Artista</th><th>Álbum</th> <th> Ano de Lançamento</th> <th> Ouvir Música </th>
                   </tr>                
                <%
                while (rs.next()) {
                %>
